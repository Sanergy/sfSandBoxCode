trigger syncDimension3withConfigObject on c2g__codaDimension3__c (after update, after insert, after delete) {
    
    List<c2g__codaDimension3__c > dimList =Trigger.isDelete?Trigger.old:Trigger.new;
    
    for(c2g__codaDimension3__c  dimListRecord:dimList ){
