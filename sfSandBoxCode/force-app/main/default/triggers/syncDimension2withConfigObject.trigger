trigger syncDimension2withConfigObject on c2g__codaDimension2__c (after update, after insert, after delete) {
    
    List<c2g__codaDimension2__c > dimList =Trigger.isDelete?Trigger.old:Trigger.new;
    
    for(c2g__codaDimension2__c  dimListRecord:dimList ){
