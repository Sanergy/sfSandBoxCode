trigger syncDimension1withConfigObject on c2g__codaDimension1__c (after update, after insert, after delete) {
    
    List<c2g__codaDimension1__c > dimList =Trigger.isDelete?Trigger.old:Trigger.new;
    
    for(c2g__codaDimension1__c  dimListRecord:dimList ){
